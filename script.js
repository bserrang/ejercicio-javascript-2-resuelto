...
//    * Tras añadir las clases, haced uso de "querySelectorAll" para obtener solo los elementos con valor par (el valor a tener en cuenta es el de n) y, a continuación, eliminadlos.
